  ...
  return (
    <>
      <motion.header 
        ...
        initial="hidden"
        animate="visible"
        className="fixed top-0 left-0 w-full z-[100] px-3 sm:px-4 md:px-6 lg:pl-8 lg:pr-3 py-2 sm:py-3 lg:py-4 flex items-start justify-between gap-2 sm:gap-3 lg:gap-4 pointer-events-none"
      >
        {/* --- LEFT: BRAND IDENTITY --- */}
        <div className="pointer-events-auto group shrink-0">
          <a 
            href="/"
            className="block bg-[#1b2856] p-2.5 sm:p-3 lg:p-4 rounded-xl sm:rounded-2xl shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:-rotate-2 cursor-pointer"
            onClick={(e) => { if (window.location.pathname === '/') scrollToTop(e); }}
          >
            <img 
        ...
        <div className="hidden lg:flex flex-1 justify-center min-w-0">
          <nav className={`flex items-center gap-0.5 xl:gap-1 pointer-events-auto transition-all duration-700 max-w-full ${
            isScrolled 
              ? 'bg-white/40 backdrop-blur-3xl border border-white/60 px-3 xl:px-4 py-1.5 rounded-full shadow-[0_8px_32px_0_rgba(255,255,255,0.3),inset_0_0_8px_rgba(255,255,255,0.2)]' 
              : 'bg-white/20 backdrop-blur-2xl border border-white/40 px-4 xl:px-6 py-2.5 rounded-full shadow-[0_4px_24px_0_rgba(255,255,255,0.2)]'
          }`}>
            
            {/* Home Link */}
            <div className="relative group px-2 xl:px-3 py-2 shrink-0">
              <a href="/" onClick={(e) => { if (window.location.pathname === '/') { e.preventDefault(); scrollToTop(e); } }} className="text-[14px] xl:text-[15px] font-bold uppercase tracking-wider text-[#1b2856] group-hover:text-[#ec2025] transition-colors whitespace-nowrap">
                Home
              </a>
            ...
            >
              <button className="text-[14px] xl:text-[15px] font-bold uppercase tracking-wider text-[#1b2856] group-hover:text-[#ec2025] transition-colors flex items-center gap-1 whitespace-nowrap">
                Services
            ...
            {/* Resources Link */}
            <div className="relative group px-2 xl:px-3 py-2 shrink-0">
              <a href="/resources" className="text-[14px] xl:text-[15px] font-bold uppercase tracking-wider text-[#1b2856] group-hover:text-[#ec2025] transition-colors whitespace-nowrap">
                Resources
              </a>
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 bg-[#ec2025] rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300" />
            </div>
            ...
            {/* Events Link */}
            <div className="relative group px-2 xl:px-3 py-2 shrink-0">
              <a href="/events" className="text-[14px] xl:text-[15px] font-bold uppercase tracking-wider text-[#1b2856] group-hover:text-[#ec2025] transition-colors whitespace-nowrap">
                Events
              </a>
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 bg-[#ec2025] rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300" />
            </div>
            ...
            <div className="relative group px-2 xl:px-3 py-2 shrink-0">
              <a href="/contact" className="text-[14px] xl:text-[15px] font-bold uppercase tracking-wider text-[#1b2856] group-hover:text-[#ec2025] transition-colors whitespace-nowrap">
                Contact
              </a>
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 bg-[#ec2025] rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300" />
            </div>
            ...
            <div className="relative group px-2 xl:px-3 py-2 ml-1 xl:ml-2 shrink-0">
              <a href="/tools" className="text-[14px] xl:text-[15px] font-bold uppercase tracking-wider text-[#1b2856] group-hover:text-[#ec2025] transition-colors flex items-center gap-2 whitespace-nowrap">
        ...
        <div className="hidden lg:flex items-start gap-4 pointer-events-auto shrink-0 mt-0 sm:mt-1 lg:mt-2">
        ...
        {/* MOBILE TOGGLE */}
        <div className="lg:hidden pointer-events-auto shrink-0 mt-1">
          <button 
            ...
            <div className="flex flex-col gap-3 sm:gap-4 max-w-md mx-auto w-full mt-28">
              {/* <span className="text-[#ec2025] font-mono text-xs tracking-widest uppercase mb-2">[ Menu ]</span> */}
                ...
                {[
                  ...
                  { name: 'Countries', href: '/countries', key: 'countries' },
                  { name: 'Test Prep', href: '/services/language-preparation', key: 'testPrep' },
                  { name: 'Resources', href: '/resources' },
                  { name: 'Events', href: '/events' },
                  { name: 'About', href: '/about', key: 'about' },
                  { name: 'Contact', href: '/contact' }
                ].map((item, i) => (
                  <div key={item.name} className="flex flex-col border-b border-white/10 last:border-0">
                    <div className="flex items-center justify-between">
                      <motion.a
                        ...
                        href={item.href}
                        onClick={(e) => { if (window.location.pathname === item.href) { e.preventDefault(); setIsMobileMenuOpen(false); } else { setIsMobileMenuOpen(false); } }}
                        className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight hover:text-[#ec2025] transition-colors py-2 flex-grow"
                      >
                        {item.name}
                      </motion.a>
                      {item.key && dropdowns[item.key] && (
                        <motion.button 
                        ...
                        >
                          <svg className={`w-6 h-6 transition-transform duration-300 ${openDropdown === item.key ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <AnimatePresence>
                      {item.key && openDropdown === item.key && dropdowns[item.key] && (
                        <motion.div 
                          initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }}
                          className="overflow-hidden flex flex-col gap-2 pl-4 py-2"
                        >
                          {dropdowns[item.key].items.map((subItem, idx) => (
                            <a 
                              key={idx} href={subItem.link} 
